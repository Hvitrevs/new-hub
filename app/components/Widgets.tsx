  ...
  return (
    <div>
        <motion.div
          ...
          className='Welcome-text  mt-[10px] rounded-sm bg-transparent border-[1px] shadow-md border-t-[4px] border-[#feffff] dark:border-t-[4px] dark:border-[#2c2f4a] dark:shadow-[#171a31] text-[#324255] dark:text-[#b7bad9] dark:bg-none'
        >
            <div 
